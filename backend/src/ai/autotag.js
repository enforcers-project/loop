...
const INTEREST_RULES = [
  ...
  // Jazz is its own onboarding interest ('jazz' → 'Jazz & Neo-Soul') and Loopy
  // gets asked for "jazz" specifically all the time — so pull it out of
  // live-bands into its own rule. Covers straight-ahead jazz, bebop, big-band
  // vocab, neo-soul, fusion, and the vinyl-listening subculture. Kept
  // narrower than live-bands so a country karaoke night doesn't fire it.
  {
    slug: 'jazz',
    category: 'music',
    keywords: [
  ...
  },
  {
    slug: 'rnb',
    category: 'music',
    keywords: ['r&b', 'rnb', 'soul music', 'gospel brunch', 'live sax'],
  },
  {
    slug: 'latin',
    category: 'music',
    keywords: ['salsa', 'bachata', 'merengue', 'reggaeton', 'bossa nova', 'mambo', 'cha-cha'],
  },
  {
    slug: 'indie',
    category: 'music',
    keywords: ['indie rock', 'indie band', 'indie showcase', 'punk', 'hardcore', 'metal', 'thrash'],
  },
  {
    slug: 'kpop',
    category: 'music',
    keywords: ['k-pop', 'kpop', 'k pop', 'random play dance', 'blackpink', 'bts', 'newjeans'],
  },
