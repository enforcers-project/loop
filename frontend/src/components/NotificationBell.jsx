...
export function NotificationBell() {
  ...
  return (
    <div ref={rootRef} className="relative">
      ...
      {open && (
        <div className="absolute right-0 top-12 z-40 w-80 max-w-[calc(100vw-2rem)] overflow-hidden rounded-card border border-border-light bg-card-bg shadow-card-hover">
